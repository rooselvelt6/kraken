...
pub fn load_all_analyzers() -> Vec<Box<dyn LanguageAnalyzer + Send + Sync>> {
    vec![
        ...
        Box::new(c_cpp::CAnalyzer),
        Box::new(c_cpp::CppAnalyzer),
        Box::new(web::JavaScriptAnalyzer),
        Box::new(web::TypeScriptAnalyzer),
        Box::new(web::WebAppAnalyzer),
        Box::new(os::LinuxKernelAnalyzer),
        Box::new(os::OpenBSDAnalyzer),
        Box::new(os::FreeBSDAnalyzer),
        Box::new(go::GoAnalyzer::default()),
        Box::new(java::JavaAnalyzer::default()),
        Box::new(swift::SwiftAnalyzer::default()),
        Box::new(lua::LuaAnalyzer),
        Box::new(docker::DockerAnalyzer),
        Box::new(kubernetes::KubernetesAnalyzer),
        Box::new(terraform::TerraformAnalyzer),
        Box::new(cloudformation::CloudFormationAnalyzer),
    ]
}
